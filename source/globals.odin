...
sym: struct {
	accel, align, ang_accel, ang_drag, ang_vel, atlas: mrb.Value,
	body, bounds, circle, clip, color:                 mrb.Value,
	...
	holes, interval, layer, leading, lifetime, line:   mrb.Value,
	loop, margin, mask, max:                           mrb.Value,
	mode, offset, outline:                             mrb.Value,
	pitch, pixel, polyphony, pos:                      mrb.Value,
	rate, rect, restitution, rotation, rounded:        mrb.Value,
	scale, sensor, shape, size, slide, snap:           mrb.Value,
